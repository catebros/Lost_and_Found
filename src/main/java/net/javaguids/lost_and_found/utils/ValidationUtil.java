...
import java.util.regex.Pattern;
 ...
 // Utility class for validating user input and data integrity. Provides validation for emails, passwords, and item data.
public class ValidationUtil {
    ...
    // Validates that an item has all required fields populated. Checks that title, description, category, and location are not null or empty.
